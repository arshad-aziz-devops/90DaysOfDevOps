...
Sleeping State: idle process
Stopped state: Suspended, can be resumed
Zombie state: Process is terminated but its entry in process table still exists as parent has not read its exist staius yet
